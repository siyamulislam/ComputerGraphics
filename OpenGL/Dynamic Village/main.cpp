...
void backgroundtree()
{
    ...
    glVertex2f(0.52f,0.66f);
    glVertex2f(0.52f, 0.72f);
    glVertex2f(0.5f,0.69f);/// plam tree
    glVertex2f(0.48f,0.72f);
    glVertex2f(0.48f, 0.66f);
    glVertex2f(0.42f,0.66f);
    glVertex2f(0.45f,0.63f);
    ...
    glVertex2f(0.9f,0.6f);
    glVertex2f(0.82f, 0.64);
    glVertex2f(0.75f, 0.67);///last hill
    glVertex2f(0.68f, 0.64);
    glVertex2f(0.6f,0.6f);
    glVertex2f(0.57f, 0.56);
    glVertex2f(0.52f, 0.5f);
    ...
    glColor3ub(205,210,167);
    glVertex2f(-0.5f,0.45f);
    glVertex2f(-0.48f, 0.5f);
    glVertex2f(-0.45f, 0.56);
    glVertex2f(-0.42f,0.6f);
    glVertex2f(-0.37f, 0.62);///2nd hill
    ...
    glBegin(GL_POLYGON);
    glColor3ub(34,139,34);
    glColor3ub(118,144,85);
    glVertex2f(0.5f,0.45f);
    glVertex2f(0.48f, 0.5f);
    glVertex2f(0.45f, 0.56);
    glVertex2f(0.42f,0.6f);
    glVertex2f(0.37f, 0.62);///4th hill
    glVertex2f(0.32f, 0.6);
    glVertex2f(0.29f, 0.56f);
    glVertex2f(0.27f, 0.5f);
    glVertex2f(0.25f,0.45f);
...
{
    glBegin(GL_POLYGON);
    glColor3ub(218, 70, 100);
    glColor3ub(138, 97, 50);
...
void boat()
{
    ...
    glBegin(GL_POLYGON);
    glColor3ub(20,51,107);

    glColor3ub(179,210,91);
    glColor3ub(222,49,123);
...
void Straw()
{
    ...
    //  glColor3ub(160, 130, 90);
    glColor3ub(237, 170, 53);
...
void well()
{
    ...
    glBegin(GL_POLYGON);
    glColor3ub(35, 93, 101);
    glColor3ub(145, 99, 88);
    glVertex2f(-0.9f,-0.35f);// lower
    ...
    glBegin(GL_POLYGON);
    glColor3ub(108, 139, 90);
    glColor3ub(91, 63, 55);;
    glVertex2f(-0.9f,-0.35f); //midlde
...
void well1()
{
    ...
    glVertex2f(-0.65f,-0.575f);
    glVertex2f(-0.6f,-0.55f);
    glVertex2f(-0.6f,-0.35f);//iiiiiiiiiiiiiiiiiiiiiiiiii
    glEnd();
...
void StartingText()
{
    ...
    sprintf(text, "___DYNAMIC VILLAGE___",5.00,8.00);
    glColor3f(0, 0, 1);
    glRasterPos2f( -25 , 30 );
    ...
    sprintf(text, "~~The Beauty of Nature~~",5.00,8.00);
    glColor3f(0, 0, 0.7);
    glRasterPos2f( -18 , 24 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text,"  Press 'D' FOR DAY MODE | PRESS 'N' FOR NIGHT MODE | PRESS 'R' FOR RAIN MODE",5.00,8.00);
    glColor3f(0, 1, 0);
    glRasterPos2f( -60 , 0 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text,"--TEAM MEMBERS--",5.00,8.00);
    glColor3f(1, 0, 0.5);
    glRasterPos2f( -16 , -16 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text,"1. 'SIYAMUL ISLAM SIYAM' | ID: 171-15-8865");
    glColor3f(0, 1, 1);
    glRasterPos2f( -32 , -25 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text,"2. 'MAINUR RAHMAN MURAD' | ID: 171-15-8758");
    glColor3f(0, 1, 1);
    glRasterPos2f( -32 , -30 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text,"3. 'SAIF AL ISLAM'       | ID: 171-15-8687");
    glColor3f(0, 1, 1);
    glRasterPos2f( -32 , -35 );
    for(int i = 0; text[i] != '\0'; i++)
    {
...
void handleKeypress(unsigned char key, int x, int y)
{
    ...
    case  'd':
        ...
        glutCreateWindow("Dynamic Village | The Beauty of Nature | Day Mode");
    ...
    case 'r':
        ...
        glutInitWindowSize(1240, 750);
        glutInitWindowPosition((glutGet(GLUT_SCREEN_WIDTH)-1240)/2,(glutGet(GLUT_SCREEN_HEIGHT)-750)/2);
        glutCreateWindow("Dynamic Village | The Beauty of Nature | Rain Mode");
        glutKeyboardFunc(handleKeypress);
    ...
    case 'n':
        ...
        glutInitWindowSize(1240, 750);
        glutInitWindowPosition((glutGet(GLUT_SCREEN_WIDTH)-1240)/2,(glutGet(GLUT_SCREEN_HEIGHT)-750)/2);
        glutCreateWindow("Dynamic Village | The Beauty of Nature | Night Mode");
        glutKeyboardFunc(handleKeypress);
...
int main(int argc, char** argv)
{
    ...
    glutInitWindowSize(1240, 750);
    glutInitWindowPosition((glutGet(GLUT_SCREEN_WIDTH)-1240)/2,(glutGet(GLUT_SCREEN_HEIGHT)-750)/2);
    glutCreateWindow("Dynamic Village | The Beauty of Nature");
    init();
